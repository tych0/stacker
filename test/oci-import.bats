...
EOF
    ...
    skopeo --insecure-policy copy $CENTOS_OCI oci:oci:centos
    stacker build
...
centos2:
    from:
        ...
        url: dest:centos
EOF
    skopeo --insecure-policy copy $CENTOS_OCI oci:dest:centos
    stacker build
...
centos3:
    ...
    run:
        touch /zomg
EOF
    skopeo --insecure-policy copy $CENTOS_OCI oci:dest:centos:0.1.1
    stacker build
