...
func doUnpack(ctx *cli.Context) error {
	fmt.Println("oci-dir", ctx.String("oci-dir2"))
	oci, err := umoci.OpenLayout(ctx.String("oci-dir2"))
	if err != nil {
		return err
	}
...
func doRepack(ctx *cli.Context) error {
	...
	return umoci.Repack(oci, ctx.String("tag"), bundlePath, meta, history, nil, true, mutator, ctx.Uint64("max-layer-size"))
}
